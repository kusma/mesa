                          ...
                          const struct pipe_viewport_state *viewports)
{
   ...
   context->guardband[1] = u_bitcast_f2u((4096 - viewports[0].scale[0]) / viewports[0].scale[0]);
   context->guardband[2] = u_bitcast_f2u((4096 - fabs(viewports[0].scale[1])) / fabs(viewports[0].scale[1]));
   context->guardband[3] = u_bitcast_f2u((4 - viewports[0].scale[2]) / viewports[0].scale[2] - powf(2.0f, -12));
}
...
{
   struct tegra_stream *stream = &context->gr3d->stream;
   tegra_stream_push_words(stream, context->viewport, 7, 0);
}
