...
main(int argc, char **argv)
{
   ...
   for (; n < argc; ++n) {
      ...
      int num_alu_instrs, num_mfu_instrs, num_fp_instrs;
      ...
      case PIPE_SHADER_FRAGMENT:
         ...
         num_alu_instrs = list_length(&fp.alu_instructions);
         printf("alu-words(%d):\n", num_alu_instrs * 4 * 2);
         ...
         num_mfu_instrs = list_length(&fp.mfu_instructions);
         printf("mfu-words(%d):\n", num_mfu_instrs * 2);
         ...
         num_fp_instrs = list_length(&fp.fp_instructions);
         printf("dw-words(%d):\n", num_fp_instrs);
