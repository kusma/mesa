...
static struct vpe_dst_operand
emit_output(struct tegra_vpe_shader *vpe, int index,
...
static struct vpe_dst_operand
tgsi_dst_to_vpe(struct tegra_vpe_shader *vpe, const struct tgsi_dst_register *dst, bool saturate)
{
   switch (dst->File) {
...
static struct vpe_src_operand
tgsi_src_to_vpe(struct tegra_vpe_shader *vpe, const struct tgsi_src_register *src)
{
...
static struct vpe_instr *
tgsi_to_vpe(struct tegra_vpe_shader *vpe, const struct tgsi_full_instruction *inst)
{
